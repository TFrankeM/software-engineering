...
class TestProductDAO(unittest.TestCase):
    ...
    def setUp(self):
        ...
        """
        self.connection = sqlite3.connect(":memory:")           # (in-memory)
    ...
    def test_find_product_by_id(self):
        ...
        """
        product = Product(name="Soda", description="A can of soda", price=1.5, quantity=50)
        self.product_dao.insert_product(product)
        
        found_product = self.product_dao.find_product_by_id(str(product.id))
        self.assertIsNotNone(found_product)
        self.assertEqual(found_product[1], "Soda")
    ...
    def test_update_product_quantity(self):
        ...
        """
        product = Product(name="Water", description="A bottle of water", price=1.0, quantity=200)
        self.product_dao.insert_product(product)
    ...
    def test_delete_product(self):
        ...
        """
        product = Product(name="Juice", description="A bottle of juice", price=3.0, quantity=75)
        self.product_dao.insert_product(product)
